        ...
        <div className='container client-group'>
          ...
          <div className="col xs-12 client-text">
            <div className="col-xs-12 stack">
              STACK: {this.props.client.stack.sort().join(' • ') }
            </div>
            <div className='row'>
              ...
              <div className="col-sm-12 col-md-4">
                ...
                <ul className="list-unstyled features">
                  {this.props.client.features.sort().map((f, i) => (<li key={i}>{f}</li>))}
                </ul>
              </div>
            </div>
          </div>
          {this.props.client.url &&
            <div className="col xs-12 sitelink">
              <a href={this.props.client.url[1]} className="site-button" target="_blank" rel="noopener noreferrer">{this.props.client.url[0]} SITE</a>
            </div>
          }
